...
public class Permissions {
     ...
     */
    private static void requestPermission(AppCompatActivity activity, int requestId,
    ...
    public static class Request {
        ...
        static final int READ_CONTACTS = 4;
        public static final int ACCESS_FINE_LOCATION = 5;
        static final int ACCESS_COARSE_LOCATION = 6;
        static final int RECORD_AUDIO = 7;
    }
